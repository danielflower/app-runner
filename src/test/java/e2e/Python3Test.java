...
import com.danielflower.apprunner.runners.PythonRunnerTest;
...
public class Python3Test {
    ...
    private final String appId = "python3";
    ...
    public void canCreateAnAppViaTheRestAPI() throws Exception {
        ...
        assertThat(restClient.homepage(appId), is(equalTo(200, containsString("Python 3 in AppRunner"))));
    }
}
