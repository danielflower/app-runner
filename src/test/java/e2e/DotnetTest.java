...
import com.danielflower.apprunner.runners.DotnetRunnerTest;
...
public class DotnetTest {
    ...
    public void start() throws Exception {
        DotnetRunnerTest.ignoreTestIfNotSupported();
        app.start();
    }
    ...
    public void canCreateAnAppViaTheRestAPI() throws Exception {
        ...
        assertThat(restClient.homepage(appId), is(equalTo(200, containsString(".NET Core sample project"))));
    }
}
